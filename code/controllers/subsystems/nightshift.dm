...
/datum/controller/subsystem/nightshift/proc/update_nightshift(active, announce = TRUE)
	...
	if(announce)
		if(active)
			announce("Добрый вечер, экипаж. Чтобы уменьшить потребление энергии и стимулировать циркадные ритмы некоторых рас, все освещение на борту станции было приглушено для создания ночной атмосферы.")
		else
			announce("Доброе утро, экипаж. Поскольку сейчас день, все освещение на борту станции были восстановлено до их прежней яркости.")
