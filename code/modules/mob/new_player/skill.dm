...
var/global/list/SKILL_PRE = list("Engineer" = SKILL_ENGINEER, "Роботехник" = SKILL_ORGAN_ROBOTICIST, "Офицер безопасности" = SKILL_SECURITY_OFFICER, "Химик" = SKILL_CHEMIST)
