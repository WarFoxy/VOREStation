...
/datum/event/wallrot/announce()
	if(center)
		command_announcement.Announce("Вредоностные грибы обнаружены вблизи [center.loc.name]. Конструкции станции [station_name()] могут быть загрязнены.", "Biohazard Alert")
