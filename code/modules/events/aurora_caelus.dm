...
/datum/event/aurora_caelus/announce()
	...
	Мы надеемся, что данное зрелище вам понравится.", "Отдел Метеорологии Nanotrasen", new_sound = 'sound/AI/aurora.ogg')
...
/datum/event/aurora_caelus/end()
	command_announcement.Announce("Показателт звездного света вернулись в норму, и облако рассеялось. \
...
"Отдел Метеорологии Nanotrasen", new_sound = 'sound/AI/aurora_end.ogg')
	..()
