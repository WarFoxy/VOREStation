...
/datum/gear/accessory/brown_vest
	...
	allowed_roles = list("Инженер","Атмосферный техник","Главный инженер","Security Officer","Detective","Head of Security","Warden","Paramedic","Главврач","Медик", "Search and Rescue")
...
/datum/gear/accessory/stethoscope
	...
	allowed_roles = list("Главврач","Медик","Химик","Psychiatrist","Paramedic", "Search and Rescue")
