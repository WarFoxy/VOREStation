...
/datum/gear/accessory/brown_vest
	...
	allowed_roles = list("Инженер","Атмосферный техник","Главный инженер","Security Officer","Detective","Head of Security","Warden","Парамедик","Главврач","Медик", "Search and Rescue")
