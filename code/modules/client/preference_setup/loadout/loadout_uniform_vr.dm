...
/datum/gear/uniform/job_khi/med
	...
	allowed_roles = list("Главврач","Медик","Химик","Парамедик","Geneticist","Field Medic")
...
/datum/gear/suit/job_fed/medsci
	...
	allowed_roles = list("Главврач","Медик","Химик","Парамедик","Geneticist","Research Director","Scientist", "Roboticist", "Xenobiologist","Pathfinder","Explorer","Field Medic")
