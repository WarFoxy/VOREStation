...
/datum/event2/event/ion_storm/announce()
	if(prob(announce_odds))
		command_announcement.Announce("Ионный шторм обнаружен вблизи [location_name()]. \
		Проверьте все ИИ на наличие повреждений", "Anomaly Alert", new_sound = 'sound/AI/ionstorm.ogg')
